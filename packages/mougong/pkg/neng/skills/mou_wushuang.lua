...
Fk:loadTranslationTable{
  ["mou__wushuang"] = "无双",
  [":mou__wushuang"] = "锁定技，当你使用【杀】指定目标后，其使用【闪】抵消此【杀】的方式改为需连续使用两张【闪】；" ..
  "当你使用【决斗】指定目标后，或当你成为【决斗】的目标后，你令其打出【杀】响应此【决斗】的方式改为需连续打出两张【杀】。" ..
  "每回合限一次，当此【杀】或【决斗】对其造成伤害时，若其未使用或打出【杀】或【闪】响应过此牌，则此伤害+1。",
