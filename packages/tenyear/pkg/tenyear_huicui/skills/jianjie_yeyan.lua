...
Fk:loadTranslationTable{
  ["jj__yeyan"] = "业炎",
  [":jj__yeyan"] = "限定技，出牌阶段，你可以移去“龙印”和“凤印”并指定一至三名角色，你分别对这些角色造成至多共计3点火焰伤害；"..
  "若你对一名角色分配2点或更多的火焰伤害，你须先弃置四张不同花色的手牌并失去3点体力。",
}
...
yeyan:addEffect("active", {
  ...
  on_use = function(self, room, effect)
    ...
    room:handleAddLoseSkills(player, "-jj__yeyan|-jj__huoji|-jj__lianhuan", nil, false)
    room:setPlayerMark(player, "@@dragon_mark", 0)
    room:setPlayerMark(player, "@@phoenix_mark", 0)
