return {
  ...
  ["ol__caoren"] = "Cao Ren",
  ["ol__jushou"] = "Entrenched",
  ["#ol__jushou_select"] = "Entrenched",
  [":ol__jushou"] = "At End Phase, can flip, draw 4 cards and then "..
    "discard 1 hand card. If the discarded card is equipment card, use that card instead.",
  ["ol__jiewei"] = "Siege",
  ["#ol__jiewei_trigger"] = "Siege",
  [":ol__jiewei"] = "The cards in your equipment area can be used as Negate. | "..
    "When you flip from Flipped to Unflipped state, u can discard 1 to move a card on the field.",
  ["#ol__jushou-select"] = "Entrenched: discard 1 hand card, or use 1 equipment card",
  ["#ol__jiewei-discard"] = "Siege: can discard 1 to move a card on the field",
  ["#ol__jiewei-choose"] = "Siege: move a card on the field",
  ...
  ["ol__zhoutai"] = "Zhou Tai",
  ["ol__buqu"] = "Refusing Death",
  [":ol__buqu"] = " When u on the brink-of-death, show 1 card from the top of draw pile. If its value is ≠ than all the Wounds, place it atop your hero (named Wound), heal to 1 HP. | "..
