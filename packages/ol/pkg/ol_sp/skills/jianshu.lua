...
Fk:loadTranslationTable{
  ["ol__jianshu"] = "间书",
  [":ol__jianshu"] = "限定技，出牌阶段，你可以交给一名其他角色一张黑色手牌，并选择另一名角色，然后令这两名角色拼点："..
  "赢的角色弃置两张牌，没赢的角色失去1点体力。",

  ["#ol__jianshu"] = "间书：将一张黑色手牌交给一名角色，再选择另一名角色与其拼点",
  ["#ol__jianshu-choose"] = "间书：选择一名角色与 %dest 拼点",

  ["$ol__jianshu1"] = "来，让我看一出好戏吧。",
  ["$ol__jianshu2"] = "纵有千军万马，离心则难成大事。",
}
...
jianshu:addEffect("active", {
  ...
  on_use = function(self, room, effect)
    ...
    local to = room:askToChoosePlayers(player, {
      ...
      min_num = 1,
      max_num = 1,
      prompt = "#ol__jianshu-choose::"..target.id,
