...
官网： https://libgit2.org
  ...
  ["Companions"] = "珠联璧合",
  ["Skill Name"] = "技能名称",
  ["Skill Description"] = "技能",
  ["Audio Text"] = "台词",
  ["General Statistics Overview"] = "数据",
  ["Other Same Name Generals"] = "同名武将",
  ["Skill Source Code"] = "源码",
  ["Death audio"] = "阵亡",
  ["Win audio"] = "胜利",
  ["Official"] = "官方",
  ["Title"] = "称号",
  ...
  ["#AskForSkillInvoke"] = "你想发动〖%arg〗吗？",
  ["#AskForLuckCard"] = "你想使用手气卡吗？还可以使用 %arg 次，剩余手气卡∞张",
  ["AskForLuckCard"] = "手气卡",
  ["#AskForChoice"] = "%arg：请选择",
  ...
  ["#AskForChooseCard"] = "%arg：请选择%src的一张卡牌",
  ["#AskForChooseCards"] = "%arg：请选择%src的%arg2至%arg3张卡牌",
  ["$ChooseCard"] = "请选择一张卡牌",
  ...
  ["$Judge"] = "判定区",
  ["$Selected"] = "已选择",
  ["#AskForUseActiveSkill"] = "请发动〖%arg〗",
  ["#AskForUseCard"] = "请使用【%arg】",
  ["#AskForResponseCard"] = "请打出【%arg】",
...
Fk:loadTranslationTable {
  ...
  ["#RemoveTargetsBySkill"] = "由于 %arg 的效果，%from 使用的 %arg2 减少了目标 %to",
