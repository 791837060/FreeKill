...
local GameEventWrappers = require "ltk.server.events"
...
function Room:askToNullification(players, params)
  ...
  repeat
    ...
    local data = {card_name, pattern, prompt, cancelable, {
      -- 以QML中实际用到的为准得了 这些变量根本没在注释中记载
      effectFrom = extra_data.effectFrom,
      effectTo = extra_data.effectTo,
      effectCardId = extra_data.effectCardId,
      useEventId = extra_data.useEventId,
    }, disabledSkillNames}
